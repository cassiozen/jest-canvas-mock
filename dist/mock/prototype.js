...
const isMockFunction = (fn) => !!fn && fn.__isSpy === true;
...
function mockPrototype() {
  ...
  if (!isMockFunction(HTMLCanvasElement.prototype.getContext)) {
  ...
  if (!isMockFunction(HTMLCanvasElement.prototype.toBlob)) {
  ...
  if (!isMockFunction(HTMLCanvasElement.prototype.toDataURL)) {
...
export { mockPrototype as default };
